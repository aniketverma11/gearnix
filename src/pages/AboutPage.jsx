                ...
                <div className="container">
                    <div className="about-main">
                        <div className="about-image">
                            <img src="https://images.unsplash.com/photo-1553877522-43269d4ea984?w=600&q=80" alt="About ITWorld Trading" />
                        </div>
                        <div className="about-text">
                            <h2>About ITWorld Trading LLC</h2>
